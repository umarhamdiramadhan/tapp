...
const outbox_validation_1 = require("./outbox-validation");
class OutboxService {
    static view(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const searchRequest = validation_1.Validation.validate(outbox_validation_1.OutboxValidation.VIEW, request);
            ...
            const outboxs = yield database_1.prismaClient.outbox.findMany({
                where: {
                    date: {
                        gte: startOfDayUTC,
                        lte: endOfDayUTC
            ...
            const total = yield database_1.prismaClient.outbox.count({
                where: {
                    AND: filters
                }
            });
            return {
                data: outboxs.map(outboxs => (0, outbox_model_1.toOutboxResponse)(outboxs)),
                paging: {
