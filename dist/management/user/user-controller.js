    ...
    static register(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield user_service_1.UserService.register(req.user, request);
                res.status(200).json({
                    data: response
                });
            }
    ...
    static delete(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield user_service_1.UserService.delete(req.user, request);
                res.status(200).json({
    ...
    static get(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield user_service_1.UserService.view(request);
